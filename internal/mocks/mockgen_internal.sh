...
TEMP_DIR=$(mktemp -d)
mkdir -p $TEMP_DIR/src/github.com/lukedirtwalker/quic-go/internalpackage

cp -r $GOPATH/src/github.com/lukedirtwalker/quic-go/internal/* $TEMP_DIR/src/github.com/lukedirtwalker/quic-go/internalpackage
